...
If not [create a new issue](https://github.com/wilcommerce/Wilcommerce.Core.Data.EFCore/issues) and describe it clearly. 
...
- Write unit tests adding your test class to the **Wilcommerce.Core.Data.EFCore.Test** project.
- Run **all** the tests to avoid breaking changes.

## Submitting Changes
- Push your changes to your feature branch in your fork.
- [Submit a pull request](https://github.com/wilcommerce/Wilcommerce.Core.Data.EFCore/pulls)
